...
# Official llm-deepseek resolves the key per request. An empty value is worse
# than unset: compose often injects DEEPSEEK_API_KEY="" from a blank .env.
...
# Official dsh is installed from npm. This image then adds every local bundle
